    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto p-4">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-600">Tìm thấy {filteredProducts.length} sản phẩm</p>
        </div>
        ...
        <Row gutter={[16, 16]}>
          <Col xs={24} md={6}>
            <Card title="Bộ lọc sản phẩm" className="shadow-sm">
              ...
              <Rate value={minRating} onChange={handleRatingChange} className="text-sm" />
            </Card>
          </Col>
          ...
          <Col xs={24} md={18}>
            <div className="mb-4 flex justify-between items-center">
              ...
              <div>
                ...
                <Select value={sortOrder} onChange={handleSortChange} style={{ width: 200 }} placeholder="Sắp xếp">
                ...
                <Col xs={24} sm={12} md={8} key={product._id}>
                  <Card
                    ...
                    actions={[
                      ...
                      <Button key="quick-view" icon={<EyeOutlined />} onClick={() => setQuickViewProduct(product)}>
                        Xem nhanh
                      </Button>,
                    ]}
                  ...
                  >
                    <Card.Meta
                      title={
                        <Link href={`/products/${product.slug}`} aria-label={`Xem chi tiết ${product.name}`}>
                          <div className="text-lg font-semibold line-clamp-2 h-12">{product.name}</div>
                        </Link>
                      }
                      description={
                        <div className="flex flex-col flex-grow">
                          ...
                          {product.installment_available && <p className="text-green-600 text-sm">Hỗ trợ trả góp</p>}
                          <p className="text-gray-500 text-sm mt-auto">Còn {product.stock} sản phẩm</p>
                        </div>
                      }
                    />
                  </Card>
            ...
            <Row gutter={[16, 16]}>
              ...
              <Col xs={24} md={12}>
                ...
                <div className="flex items-center mb-2">
                  ...
                  <span className="text-sm text-gray-500">({Math.round(quickViewProduct.rating * 20)} đánh giá)</span>
                </div>
                ...
                <Space>
                  ...
                  <Link href={`/products/${quickViewProduct.slug}`}>
                    <Button onClick={() => setQuickViewProduct(null)}>Xem chi tiết</Button>
                  </Link>
                </Space>
              </Col>
            </Row>
