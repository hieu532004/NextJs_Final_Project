...
//   totalAfterDiscount,
//   onCancel,
//   orderData, // Nhận dữ liệu đơn hàng từ component cha
//   onCreateOrder, // Callback để gọi khi thanh toán thành công
// }: {
...
//         onCreateOrder({ ...orderData, paymentStatus: "success" }); // Gọi callback để tạo đơn hàng
//       } else {
//         setPaymentStatusMessage("Thanh toán thất bại. Vui lòng thử lại!");
//         setLoading(false);
//       }
//     }, 3000); // Mô phỏng thời gian gọi API
//   };
...
//                 <p className="font-medium">THANHTOAN {/* Bạn có thể thêm orderId nếu cần */}</p>
//               </div>
//             </div>
//             <div className="mt-8">
...
//           <Button type="primary" onClick={simulatePaymentVerification} loading={loading}>Đã thanh toán</Button>
//         </div>
//       </div>
//     </Modal>
//   );
